...
public class MainActivity extends AppCompatActivity {
                        ...
                        switch (menuItem.getItemId()) {
                            case R.id.Notify:
                                ...
                                if (info == null || !info.isAvailable()) {
                                    Toast.makeText(MainActivity.this, "目前沒有網路唷!所以無法進入通知", Toast.LENGTH_LONG).show();
                                }else{
    ...
    public void setFragment(int position) {
        ...
        switch (position) {
            case 0:
                ...
                fragmentTransaction.replace(R.id.fragment, notify);
            ...
            case 1:
                ...
                fragmentTransaction.replace(R.id.fragment, inbox);
                fragmentTransaction.commit();
                break;
            case 2:
                fragmentManager = getSupportFragmentManager();
            ...
            case 3:
                ...
                fragmentTransaction = fragmentManager.beginTransaction();
                Edit edit = new Edit();
                fragmentTransaction.replace(R.id.fragment, edit);
                fragmentTransaction.commit();
                break;
    ...
    private class getcontent extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            // 開啟資料傳送dialog
            pdialog = ProgressDialog.show(MainActivity.this, "請稍候", "資料讀取中", true);
            pdialog.show();
        }
            ...
            for (int i = 0; i < up_content.getCount(); i++) {
                ...
                if (reretrieve[0].equals("true")) {
                    ...
                    if (mod.equals("retrievable")) {
                        ...
                        values.put(FileContentProvider.UserSchema._CONTENT, content);
                        values.put(FileContentProvider.UserSchema._TITTLE, tittle);
                        values.put(FileContentProvider.UserSchema._USESTATUS, "");
                        values.put(FileContentProvider.UserSchema._FILEPATH, "");
                    }else{
                        values.put(FileContentProvider.UserSchema._FILENAME, content);
                    }

                    where = FileContentProvider.UserSchema._ID + " = " + id_this;
